...
use OpenRailDataExamples\NetworkRail\TdEvents\ExampleEventListener;
...
// Create the Topic.
$topic = new OpenRailData\NetworkRail\Services\Stomp\Topics\TrainDescriber\TrainDescriberTopic();
